...
BEGIN_DISPATCH_MAP(CMapView, COleControl)
	...
	// Swift API
	DISP_FUNCTION_ID(CMapView, "SetConstrainingExtents", dispidSetConstrainingExtents, SetConstrainingExtents, VT_BOOL, VTS_R8 VTS_R8 VTS_R8 VTS_R8)
	DISP_FUNCTION_ID(CMapView, "FreezeCurrentExtents", dispidFreezeCurrentExtents, FreezeCurrentExtents, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION_ID(CMapView, "SetLayerLabelMaxScale", dispidSetLayerLabelMaxScale, SetLayerLabelMaxScale, VT_EMPTY, VTS_I4 VTS_R8)
	DISP_FUNCTION_ID(CMapView, "SetLayerLabelMinScale", dispidSetLayerLabelMinScale, SetLayerLabelMinScale, VT_EMPTY, VTS_I4 VTS_R8)
	DISP_FUNCTION_ID(CMapView, "SetLayerLabelColumn", dispidSetLayerLabelColumn, SetLayerLabelColumn, VT_EMPTY, VTS_I4 VTS_BSTR)
	DISP_FUNCTION_ID(CMapView, "SetLayerFeatureColumn", dispidSetLayerFeatureColumn, SetLayerFeatureColumn, VT_EMPTY, VTS_I4 VTS_BSTR)
	DISP_FUNCTION_ID(CMapView, "SetLayerLabelAttributes", dispidSetLayerLabelAttributes, SetLayerLabelAttributes, VT_EMPTY, VTS_I4 VTS_BSTR VTS_I4 VTS_BOOL)
	...
	DISP_FUNCTION_ID(CMapView, "SetLayerLabelFrame", dispidSetLayerLabelFrame, SetLayerLabelFrame, VT_EMPTY, VTS_I4 VTS_I4 VTS_I4)
	...
	DISP_FUNCTION_ID(CMapView, "AddDatasourceAndResave", dispidAddDatasourceAndResave, AddDatasourceAndResave, VT_I4, VTS_BSTR VTS_BSTR VTS_BSTR VTS_BOOL)
	DISP_FUNCTION_ID(CMapView, "QueryLayer", dispidQueryLayer, QueryLayer, VT_BSTR, VTS_I4 VTS_BSTR)
	DISP_FUNCTION_ID(CMapView, "AddUserLayer", dispidAddUserLayer, AddUserLayer, VT_I4, VTS_I4 VTS_BSTR VTS_BOOL)
	DISP_FUNCTION_ID(CMapView, "AddUserPoint", dispidAddUserPoint, AddUserPoint, VT_BSTR, VTS_R8 VTS_R8)
	DISP_FUNCTION_ID(CMapView, "RemoveUserGeometry", dispidRemoveUserGeometry, RemoveUserGeometry, VT_EMPTY, VTS_I4 VTS_I4)
	...
	DISP_FUNCTION_ID(CMapView, "ZoomToGeometry", dispidZoomToGeometry, ZoomToGeometry, VT_R8, VTS_I4 VTS_I4)
	...
	DISP_FUNCTION_ID(CMapView, "LockWindowEx", dispidLockWindowEx, LockWindowEx, VT_EMPTY, VTS_NONE)
	...
	DISP_FUNCTION_ID(CMapView, "EndMeasuring", dispidEndMeasuring, EndMeasuring, VT_EMPTY, VTS_BOOL)
