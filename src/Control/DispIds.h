enum {		//{{AFX_DISP_ID(CMapView)
	...
	dispidSetMeasureLineColor = 308L,
	dispidGetMeasurePoint = 307L,
	dispidRemoveLastMeasuringPoint = 306L,
	dispidEndMeasuring = 305L,
	dispidGetMeasureRadius = 304L,
	dispidGetMeasureWKT = 303L,
